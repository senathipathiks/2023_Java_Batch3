...
public sealed class SealedClassEg1 permits Laptop {
  
  String ComputerName;
  String Features;
  double price;
  
  public SealedClassEg1(String Cname, String Cfeatures,double price) {
...
non-sealed class Laptop extends SealedClassEg1{
  String LaptopName;
  String Features;
  double price;
