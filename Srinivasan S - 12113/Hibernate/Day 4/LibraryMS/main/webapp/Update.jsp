...
<div class=" container-fluid card bg-light mb-3"  id="card" style="max-width: 40rem;">
  <div class="card-header"><h4>Update book</h4></div>
  <div class="card-body">
  ...
  <div class="container-fluid form-group">
    ...
    <input type="text" id="bid" class="form-control" name="bid" style="width: 18rem"  placeholder="Enter book id"><br>
    ...
    <input type="submit" id="but"  class="btn btn-primary pull-right" value="Update" name="button" style="width: 5rem" onmousedown="Validation()">
