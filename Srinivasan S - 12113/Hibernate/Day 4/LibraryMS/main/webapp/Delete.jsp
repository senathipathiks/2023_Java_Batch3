...
<div class=" container-fluid card bg-light mb-3"  id="card" style="max-width: 40rem;">
  <div class="card-header"><h4>Delete book</h4></div>
  <div class="card-body">
  ...
  <div class="container-fluid form-group">
    ...
    <input type="submit" id="but"  class="btn btn-primary pull-right" value="Delete" name="button" style="width: 5rem" onmousedown="Validation()">
