...
public sealed class SealedClass permits Laptop {
    
    String ComputerName;
    String Features;
    double price;
    
    public SealedClass(String Cname, String Cfeatures,double price) {
...
non-sealed class Laptop extends SealedClass{
    String LaptopName;
    String Features;
    double price;
