    ...
    <div class="totalcontainer">
        <div class="bodycontainer">
            <div class="container1">
                    ...
                    <input class="inputbox" type="text" placeholder="Enter Id" name="sid"><br>
                
                
                    <input class="inputbox" type="text" placeholder="Enter Name" name="sname"><br>
                
                    <input class="inputbox" type="text" placeholder="Enter city" name="scity"><br>
