...
<body>
	...
	<div class="card">
	 ...
	 <form action="Insertion" modelAttribute="bean" name="loginform" method="post" onsubmit="return validation()"> 
       ...
       <input type="text" class="form-control" id="rmid" placeholder="Employee ID" name="eid" disabled="disabled">
       
     </div>
     
     <div class="form-floating mb-3">
       <label for="floatingPassword">Employee Name</label>
       <input type="text" class="form-control" id="rmtype" placeholder="Employee Name" name="ename">
       
     </div>
     <div class="form-floating mb-3">
       <label for="floatingPassword">Employee Salary</label>
       <input type="text" class="form-control" id="rmtariff" placeholder="Employee Salary" name="esalary">
