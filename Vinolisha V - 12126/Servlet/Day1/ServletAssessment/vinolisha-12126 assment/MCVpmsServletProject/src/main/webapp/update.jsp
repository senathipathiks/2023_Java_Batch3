...
<table style="border:none;" id="new">
		<tr><td><h5>UPDATE EMPLOYEE DETAILS</h5></td></tr>
		...
		<tr><td colspan="2" style="text-align: center;" id="div"><input type="submit" class="btn btn-success btn-lg" id="btn" name="button" value="Update"></td></tr>
