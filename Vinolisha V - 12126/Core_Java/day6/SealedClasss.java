...
public sealed class SealedClasss permits Laptop {
    
    String ComputerName;
    String Features;
    double price;
    
    public SealedClasss(String Cname, String Cfeatures,double price) {
...
non-sealed class Laptop extends SealedClasss{
    String LaptopName;
    String Features;
    double price;
