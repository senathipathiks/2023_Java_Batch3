...
public interface EmployeeRapo extends CrudRepository<Employee, Integer> {
...
//	public void deleteByName(@Param("ename") String ename);
	...
	public void updateByEid(Integer eid);

	public ArrayList<Employee> findByEname(String ename);
	
	public ArrayList<Employee> findByEsalary(Integer esalary);
