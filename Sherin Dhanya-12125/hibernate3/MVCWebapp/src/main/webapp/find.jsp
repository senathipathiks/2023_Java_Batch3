...
<tr>
<td colspan="2"><input type="submit" class="btn bg-info btn-lg active" value="Find" name="button" id="button" >
<input type="submit" class="btn bg-info btn-lg active" value="Find All" name="button" id="button">
</td>
</tr>
