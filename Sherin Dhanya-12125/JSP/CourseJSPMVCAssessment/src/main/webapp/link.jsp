		...
		<form  class="d-flex flex-column justify-content-center">
			<br> <br> <br>
				...
				<div class="card card-body text-center " style="width: 90%;">
					<a href="insert.jsp" class="btn btn- bg-info  " name="button"
						target="frame2">Insert</a>
				</div>
				<br>
				<div class="card card-body text-center " style="width: 90%;">
					<a href="delete.jsp" class="btn btn- bg-info " name="button"
						target="frame2">Delete</a>
				</div>
				<br>
				<div class="card card-body text-center " style="width: 90%;">
					<a href="update.jsp" class="btn btn- bg-info  " name="button"
						target="frame2">Update</a>
				</div>
				<br>
				<div class="card card-body text-center " style="width: 90%;">
					<a href="find.jsp" class="btn btn- bg-info " name="button"
