...
<div class="card mb-3" id="poster">
  <img src="https://www.shutterstock.com/image-vector/shopping-online-on-website-mobile-260nw-2106913574.jpg" class="card-img-top" alt="" style="height:250px">
  <div class="card-body">
    <h5 class="card-title">Welcome To Online Shopping</h5>
