...
<nav class="navbar navbar-expand-lg bg-body-tertiary bg-dark">
  ...
  <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10m0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6"/>
	...
	<div class="card">
		<h5 class="card-header bg-primary">Update Operation</h5>
		<div class="card-body ">
		
		<form action="Updation" modelAttribute="bean" name="loginform" onsubmit="return validation()"> 
		
        <div class="form-floating mb-3">
        <label for="floatingInput">Room ID</label>
       <select class="form-select" aria-label="Default select example" name="rmid">
