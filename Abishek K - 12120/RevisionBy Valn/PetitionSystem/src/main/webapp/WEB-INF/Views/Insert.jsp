...
<body>
	...
	<div class="card">
	 ...
	 <form action="Insertion" modelAttribute="bean" name="loginform" method="post" onsubmit="return validation()"> 
       ...
       <input type="text" class="form-control" id="rmid" placeholder="Petition ID" name="petid" disabled="disabled">
     ...
     <div class="form-floating mb-3">
       ...
       <input type="text" class="form-control" id="rmtariff" placeholder="Description" name="description">
