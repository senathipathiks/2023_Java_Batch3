...
<div class="card">
		...
		<div class="card-body ">
			...
			<form action="MainServlet" method="post" name="loginform" onsubmit="return validation()"> 
        <div class="form-floating mb-3">
        <label for="floatingInput">Item ID</label>
       <input type="text" class="form-control" id="iDD" placeholder="Item ID" name="iId">
       
     </div>
     
     <div class="form-floating">
       <label for="floatingPassword">Item Name</label>
       <input type="text" class="form-control" id="name" placeholder="Item Name" name="iName">
       
     </div>
     <div class="form-floating">
       <label for="floatingPassword">Item Price</label>
       <input type="text" class="form-control" id="price" placeholder="Item Price" name="iPrice">
       
     </div>
     <div class="form-floating">
       <label for="floatingPassword">Item Seller</label>
       <input type="text" class="form-control" id="Seller" placeholder="Item Seller" name="iSeller">
       
     </div>
     <div class="form-floating">
       <label for="floatingPassword">Item Buyer</label>
       <input type="text" class="form-control" id="Buyer" placeholder="Item Buyer" name="iBuyer">
       
     </div>
     <div class="form-floating">
       <label for="floatingPassword">Item Status</label>
       <input type="text" class="form-control" id="status" placeholder="Item Status" name="iStatus">
     ...
     <script>
        ...
        function validation(){
           ...
           console.log(id+name+price+seller+buyer+status)  ;          
            ...
            if(id=="" || id==null) {
                ...
                alert("Please fill the  Seller Details");
                return false;
            }
            else if(buyer=="" || buyer==null){
                alert("Please fill the Buyer  Details");
                return false;
            }
            else if(status== "" || status==null){
                alert("Please fill the Status  details");
                return false;
        }
        else{
