...
<tr>
<td ><input type="submit" class="btn btn-danger btn-lg" value="Find" name="button"></td>

<td><input type="submit" class="btn btn-danger btn-lg" value="FindAll" name="button"></td>
</tr>
