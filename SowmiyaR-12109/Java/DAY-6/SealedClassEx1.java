...
//permits - used to privillege the specific mentioned classes



public sealed class SealedClassEx1 permits Laptop {
    
    String ComputerName;
    String Features;
    double price;
    
    public SealedClassEx1(String Cname, String Cfeatures,double price) {
...
non-sealed class Laptop extends SealedClassEx1{
    String LaptopName;
    String Features;
    double price;
