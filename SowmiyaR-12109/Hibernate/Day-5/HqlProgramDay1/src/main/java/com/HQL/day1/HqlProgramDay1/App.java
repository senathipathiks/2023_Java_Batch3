...
//  ========================================================
//        minimum
//        Query query=session.createQuery("select min(eid) From Employee ");
//        List employees=(List)query.getResultList();
//        for(Object min :employees) {
//        	System.out.println(min);
//          }
//  =====================================================
//        Query query=session.createQuery("select max(eid) From Employee ");
//        List employees=(List)query.getResultList();
...
//   ==============================================================
//        delete the element
//        Query q=session.createQuery("delete Employee where id=29");
//       
//        int status=q.executeUpdate();
//        if(status>0) 
