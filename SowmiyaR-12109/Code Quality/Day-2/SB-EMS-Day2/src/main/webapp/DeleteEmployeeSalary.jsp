...
<form action="PerformDeleteSalary">
<br>
<h2 align="center">Delete Employee Details</h2>
<br>
 
<table width="40%' border="0" align="center">
<tr><td><h3>Employee Salary</h3></td><td>
<select name="esalary">
...
<tr><td colspan="2" align="center"><input class="button" value="Delete Employee salary" type="submit" /></td></tr>
</table>
</form>
