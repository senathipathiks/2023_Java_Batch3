...
class CricketPlayer extends Player {
	...
	@Override
	void no_of_players() {
		System.out.println("12 Players :"+(pno+" "+pname+" "+gname));
...
class VolleyBallPlayer extends Player {
	...
	@Override
	void no_of_players() {
		System.out.println("6 Players: "+(pno+" "+pname+" "+gname));
...
class FootBallPlayer extends Player {
	...
	@Override
	void no_of_players() {
		System.out.println("8 Players: "+(pno+" "+pname+" "+gname));
...
public class AbstractPlayer {
	...
	public static void main(String[] args) {
		...
		obj1.read_Cplay(11, "Ram", "Cricket");
		obj1.no_of_players();

		VolleyBallPlayer obj2 = new VolleyBallPlayer();
		obj2.read_Vplay(22, "Raj", "VollyBall");
		obj2.no_of_players();
