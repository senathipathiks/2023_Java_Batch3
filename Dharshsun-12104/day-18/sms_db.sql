...
CREATE TABLE `student` (
  ...
  `studphoneno` int(15) DEFAULT NULL,
...
CREATE TABLE `teacher` (
  ...
  `teacherexp` int(5) DEFAULT NULL,
  `teacheraddress` varchar(20) DEFAULT NULL,
  `teacherphoneno` int(15) DEFAULT NULL,
  `teacheremail` varchar(30) DEFAULT NULL,
  `deptid` int(11) NOT NULL,
  PRIMARY KEY (`teacherid`),
  KEY `depid_idx` (`deptid`) /*!80000 INVISIBLE */,
...
-- Dump completed on 2024-01-18 17:30:08
