...
class CricketPlayer{
	void display() {
		System.out.println("Cricket Players are ready for Playing cricket");
	}
}
...
class Bowler extends Batsman{
	void display() {
		System.out.println("The Bowler are doing the bowling in cricket match");
	}
}
public class InheritanceCricket {
