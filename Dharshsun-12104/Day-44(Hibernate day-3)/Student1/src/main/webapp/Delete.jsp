...
<body>
<div class="card w-50 ">
<div class="card-header text-center"><h5>Enter the Student Id to Delete : </h5></div>
<div class="card-body ">
<form action="StudentMain" method="post">
<table style="border:none;">
<tr><td>Enter Stud Id</td><td>: <input type="number" name="studId" autocomplete="off" placeholder="Enter Stud id"/> </td></tr>
