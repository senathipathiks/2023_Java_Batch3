...
public class SMSMain {
	...
	{
		System.out.println("Enter Student No, Student Name,Student address,phoneno and departmentno ");
		return new Student(sc.nextInt(),sc.next(),sc.next(),sc.nextInt(),sc.nextInt());
	}
	...
	{
		System.out.println("Enter Student No, Student Name,Student address,studentphoneno,deptid");
		return new Student(sc.nextInt(),sc.next(),sc.next(),sc.nextInt(),sc.nextInt());
	}
