...
<form action = "EmpController" method="post">
<tr><td>Employee Id:</td><td><input type="text" name="eid" value="${emp.eid}" /></td></tr>
<tr><td>Employee Name:</td><td><input type="text" name="ename" value="${emp.ename}"/></td></tr>
<tr><td>Employee Age:</td><td><input type="text" name="eage" value="${emp.eage}"/></td></tr>
<tr><td colspan="2" align="center"><input class="button" type="submit" value="UpdateEmployee" name="emsAction"/></td></tr>
</table>
</form>
</form>
<br>
