...
<div class="card-header text-center"><h5>Enter the Property Details to Update : </h5></div>
<div class="card-body ">
...
<tr><td colspan="2" style="text-align: right;"><input type="submit"  class="btn btn-info btn-md" name="button" value="Update"/> </td></tr>
</table>
</form>
</div>
</div>
