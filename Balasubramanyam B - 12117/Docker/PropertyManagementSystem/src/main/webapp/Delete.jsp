...
<div class="card-header text-center"><h5>Enter the Property Id to Delete : </h5></div>
<div class="card-body ">
...
<tr><td colspan="2" style="text-align: right;"><input type="submit"  class="btn btn-warning btn-md" name="button" value="Delete"/> </td></tr>
</table>
</form>
</div>
</div>
