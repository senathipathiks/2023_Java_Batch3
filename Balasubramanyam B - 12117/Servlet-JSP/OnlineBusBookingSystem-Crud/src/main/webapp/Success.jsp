...
<%@page import="com.obs.bean.OnlineBusBookingSystem"%>
...
<%
	...
	if(action.equals("Insert")){
		...
		<%="<tr><td>"+obs.getBusNo()+"</td><td>"+obs.getBusName()+"</td><td>"+obs.getRouteFrom()+"</td><td>"+obs.getRouteTo()+"</td><td>"+obs.getBusType()+"</td><td>"+obs.getArrival()+"</td><td>"+obs.getTotalSeats()+"</td><td>"+obs.getAvailSeats()+"</td><td>"+obs.getFare()+"</td></tr></table></div>" %>
		<%	
