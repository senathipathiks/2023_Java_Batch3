...
public class EmployeeController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equals("Insert")) {
			if(request.getParameter("Id")=="" || request.getParameter("Name")=="" || request.getParameter("Age")=="" ) {
				response.sendRedirect("Empty.jsp?action=Insert");

			}
			else {
				Employee emp = new Employee(Integer.parseInt(request.getParameter("Id")), request.getParameter("Name"), Integer.parseInt(request.getParameter("Age")));
