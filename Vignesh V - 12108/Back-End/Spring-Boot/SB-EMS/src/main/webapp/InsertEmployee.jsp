...
<tr><td>Employee Name:</td><td><input type="text" name="empName" required="required" pattern="[A-Za-z]{}"/></td></tr>
<tr><td>Employee Salary:</td><td><input type="text" name="empSalary" required="required" pattern="{0-9}"/></td></tr>
<tr><td align="center"><input class="btn btn-primary" type="submit" value="InsertEmployee" /></td></tr>
</table>
