...
<script>
    function redirectToDeletePage() {
        parent.frames['frame2'].location.href = 'delete.jsp';
    }
    function redirectToInsertPage() {
        parent.frames['frame2'].location.href = 'insert.jsp';
    }
    function redirectToUpdatePage() {
        parent.frames['frame2'].location.href = 'update.jsp';
    }
    function redirectToFindPage() {
        parent.frames['frame2'].location.href = 'view.jsp';
    }
</script>
</head>
<body>
