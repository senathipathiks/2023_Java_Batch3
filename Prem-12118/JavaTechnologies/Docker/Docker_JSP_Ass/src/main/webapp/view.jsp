...
<body>
    ...
    <form action="InsertServlet" method="post">
        <h5 class="text-center mb-4">Find Car Details below</h5>
        <div class="form-group">
            <label for="cid">Enter the Car ID to find:</label>
            <input type="text" id="cid" name="cid" placeholder="Please enter a valid car ID">
        </div>
        <div class="form-group">
