...
<div class="card w-50 ">
<div class="card-header text-center"><h5>Enter the Customer Details to View : </h5></div>
<div class="card-body ">
...
<tr>
<td style="padding: 5px;"><label>Enter Customer ID:</label></td>
<td colspan="3" style="padding: 5px;"><input type="text" name="customerID" autocomplete="off" placeholder="Enter customer id *"/></td>
</tr>
