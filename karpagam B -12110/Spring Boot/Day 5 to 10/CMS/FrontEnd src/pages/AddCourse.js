  ...
  <><div>
    ...
    id='Carder'>
        ...
        <div className="col-md-6 offset-md-3 border rounded p-4 mt-4 shadow dark ">
            <h2 className='text-center m-4' ><b className='.text-danger'> REGISTER COURSE DETAILS</b></h2>
            ...
            <div className='mb-3'>
                ...
                <div className='mb-3'>
                <label htmlFor='couresDuration' className='form-label '><b>COURSE DURATION :</b></label>
                <input type={'text'}
                 className='form-label'
                ...
                <div className='mb-3'>
                <label htmlFor='courseLecturer' className='form-label '><b>Lecture Name :</b></label>
                <input type={'text'}
                 className='form-label'
