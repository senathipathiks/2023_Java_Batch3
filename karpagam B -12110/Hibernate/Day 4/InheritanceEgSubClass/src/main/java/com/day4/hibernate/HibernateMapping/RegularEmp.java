...
@PrimaryKeyJoinColumn(name="ID") // We join the primary key, now parent table and sub table will also have key && but in concrete class it doesn't show parent class 
