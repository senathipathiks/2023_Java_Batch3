...
public class StudentController {
	...
	@PostMapping("Fetch")
	public ModelAndView doFetch(@ModelAttribute("bean") Student emp) {

		return new ModelAndView("Update").addObject("idList", dao.idList()).addObject("bean", dao.getEmployee(emp));
