...
<% 
out.print("<div class=\"card-body bg-danger\" id=\"noti\"><h3><font color=white>Record Not Found</font></h3></div>");
}
...
<%@ include file="Find.jsp" %>
<% 
out.print("<div class=\"card-body bg-danger\" id=\"noti\"><h3><font color=white>Records Not Found</font></h3></div>");
}
