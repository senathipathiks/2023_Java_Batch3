...
<%
	...
	if(action.equals("Insert")){
		...
		<%="<tr><td>"+stud.getId()+"</td><td>"+stud.getName()+"</td><td>"+stud.getCity()+"</td></tr></table></div>" %>
		<%		
		...
		<%="<br><table class=\"bg-light \" ><tr style=\"font-weight:bold row\"><td>Employee ID</td><td>Employee Name</td><td>Employee Age</td><tr></center>" %>
		<%
		for(Student stud : list){
			%>
			<%="<tr class=\" table table-light \" ><tr><td>"+stud.getId()+"</td><td>"+stud.getName()+"</td><td>"+stud.getCity()+"</td></tr></table></div>" %>
