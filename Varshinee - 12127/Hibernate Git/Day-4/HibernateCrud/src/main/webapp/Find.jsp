...
<tr>
<td colspan="2" ><input type="submit" class="btn btn-info btn-lg" value="Find" name="button"> </td>

<td colspan="2"><input type="submit" class="btn btn-info btn-lg" value="FindAll" name="button"> </td>
</tr>
</body>
</html>