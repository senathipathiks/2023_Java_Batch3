	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equals("Insert"))
		{
			...
			if(n==1) {
				...
				out.write("<h1> <font color=red> Record Inserted Successfully </font></h1>");
			}
			else
			{
				rd.include(request, response);
			...
			if(stud.size()>0) {
				...
				for(Student s:stud) {
					out.write(    "<tr>"
                            ...
                            +"<td>"+s.getName()+"</td>"
                            +"<td>"+s.getCity()+"</td>"
                            +"<td>"+"<a href=\"delete.jsp\" class=\"btn btn-danger btn-lg\" name=\"button\" target=\"frame2\">Delete</a>"+"</td>"
                            +"<td>"+"<a href=\"update.jsp\" class=\"btn btn-warning btn-lg\" name=\"button\" target=\"frame2\">Update</a>"+"</td>"
                            +"</tr>");
