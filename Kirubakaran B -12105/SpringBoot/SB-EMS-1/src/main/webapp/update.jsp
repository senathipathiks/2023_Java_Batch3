...
<div class="box">
		<form action="FetchEmp">
			<table width="80%" align="center" border="0">
				...
				<tr>
					<td colspan="3" align="center"><input type="submit"
						value="Fetch" class="btn btn-primary" /></td>
				</tr>
			</table>
			</form>
			</div>
			...
			<table width="80%" align="center" border="0">
				<tr><td>Employee id</td><td><input type="text" name="eid" readonly="readonly" value="${emp.eid}"/></td></tr>
			     <tr><td>Employee name</td><td><input type="text" name="ename" value="${emp.ename}"/></td></tr>
			     <tr><td>Employee sal</td><td><input type="text" name="esal" value="${emp.esal}"/></td></tr>
			     				<tr>
					<td colspan="3" align="center"><input type="submit"
