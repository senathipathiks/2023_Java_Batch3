...
<style>
body{
background-image: url('https://static.vecteezy.com/system/resources/previews/003/031/763/non_2x/blue-wide-background-with-radial-blurred-gradient-free-vector.jpg');
...
<body>
<div class="card card-body w-50" id="title">Library Management System</div>
...
<div class="container-fulid">
 ...
 <input class="form-control me-3" type="text" placeholder="Enter Id" aria-label="Search" name="bookId" autocomplete="off" required >
