...
class DateChecking {
	...
	public DateChecking(String date) throws InvalidDateFormat {
		...
		if((Integer.parseInt(str[0])<=31 && Integer.parseInt(str[0]) >=0 ) && monthList.contains(str[1]) && (Integer.parseInt(str[2])>=0))
...
public class CustomizedExceptionExample6 {

	public static void main(String[] args) {
		
		try {
			@SuppressWarnings("unused")
			DateChecking obj = new DateChecking("2023-Jan-23");
